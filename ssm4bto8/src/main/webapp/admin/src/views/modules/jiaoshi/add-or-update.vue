<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.zhengjian" label="证件" prop="zhengjian">
          <file-upload
          tip="点击上传证件"
          action="file/upload"
          :limit="3"
          ...
          @change="zhengjianUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.zhengjian" label="证件" prop="zhengjian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.zhengjian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
var objcross = this.$storage.getObj('crossObj');
    ...
    zhengjianUploadChange(fileUrls) {
