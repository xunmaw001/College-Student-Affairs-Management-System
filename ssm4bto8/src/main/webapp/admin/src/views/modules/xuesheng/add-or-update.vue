<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.xueshengzheng" label="学生证" prop="xueshengzheng">
          <file-upload
          tip="点击上传学生证"
          action="file/upload"
          :limit="3"
          ...
          @change="xueshengzhengUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.xueshengzheng" label="学生证" prop="xueshengzheng">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.xueshengzheng.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="学校" prop="xuexiao">
          <el-select :disabled="ro.xuexiao" v-model="ruleForm.xuexiao" placeholder="请选择学校">
            <el-option
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.lianxifangshi = true;
          ...
          if(o=='xueshengzheng'){
            this.ruleForm.xueshengzheng = obj[o];
	    this.ro.xueshengzheng = true;
            continue;
          }
          if(o=='xuexiao'){
...
var objcross = this.$storage.getObj('crossObj');
    ...
    xueshengzhengUploadChange(fileUrls) {
