        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
		    ...
		    label="联系方式">
		     <template slot-scope="scope">
                  ...
                  <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign"  prop="xueshengzheng"
                   :header-align="contents.tableAlign"
                    width="200"
                    label="学生证">
                    <template slot-scope="scope">
                      <div v-if="scope.row.xueshengzheng">
                        <img :src="$base.url+scope.row.xueshengzheng.split(',')[0]" width="100" height="100">
                      </div>
                      <div v-else>无图片</div>
                    </template>
                  </el-table-column>
